"""
Django settings for WisdomClass project.
...
SECRET_KEY = 'django-insecure-n2q$=8nw(b76lkz_^zx!14s=fv*z&aetf(zw23^wbq2wb8p3rm'
...
WSGI_APPLICATION = 'WisdomClass.wsgi.application'
